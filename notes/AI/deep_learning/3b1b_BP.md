...
<figure>
  <img src="/assets/images/deep_learning/backPropagation_pic.webp" alt="example1" />
</figure>
...
<figure>
  <img src="/assets/images/deep_learning/chainRuleInBP_pic.webp" alt="example2" />
</figure>
...
<figure>
  <img src="/assets/images/deep_learning/chainRuleInBP2_pic.webp" alt="example3" />
</figure>
不过链式法则里，$C_0$对于$a^{(L)}_k$的偏导发生了变化，因为$a^{(L)}_k$可以对多个结果神经元产生影响
<figure>
  <img src="/assets/images/deep_learning/chainRuleInBP3_pic.webp" alt="example4" />
</figure>