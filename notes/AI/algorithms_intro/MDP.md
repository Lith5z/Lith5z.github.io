...
一个马尔科夫链可以转换为搜索树
<figure>
  <img src="{{ '/assets/images/algorithms_intro/MDPchain_pic.webp' | absolute_url }}" alt="MDPchain_pic" />
</figure>
<figure>
  <img src="{{ '/assets/images/algorithms_intro/MDPtree_pic.webp' | absolute_url }}" alt="MDPtree_pic" />
</figure>

为了方便处理，搜索树中除了状态节点，还有一个q-state(s,a)，代表从s采取动作后，还未确定结果s'的节点
<figure>
  <img src="{{ '/assets/images/algorithms_intro/qstate_pic.webp' | absolute_url }}" alt="qstate_pic" />
</figure>
...
<figure>
  <img src="{{ '/assets/images/algorithms_intro/discount_pic.webp' | absolute_url }}" alt="discount_pic" />
</figure>
...
举个例子：
<figure>
  <img src="{{ '/assets/images/algorithms_intro/valueIteration_pic.webp' | absolute_url }}" alt="valueIteration_pic" />
</figure>
...
<figure>
  <img src="{{ '/assets/images/algorithms_intro/MDP_value_pic.webp' | absolute_url }}" alt="MDP_value_pic" />
</figure>
